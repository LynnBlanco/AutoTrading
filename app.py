...
def regressor(X_train, y_train):
    ...
    regressor.add(LSTM(units = 16, batch_input_shape = (1 ,X_train.shape[1], 1), stateful = True))
    
    regressor.add(Dense(units = 1))

    regressor.compile(optimizer = 'adam', loss = 'mean_squared_error')
    regressor.summary()
    regressor.fit(X_train, y_train, epochs = 30, batch_size = 1)
...
class preprocessing():
    ...
    def data_load(self):
        ...
        # data_visualization(self.train, self.test)
...
if __name__ == '__main__':
    ...
    # predicted stock price real time
    ...
    # predicted stock price use model
    ...
    # print("RMSE:", np.sqrt(metrics.mean_squared_error(testing_data, predicted_stock_price)))
